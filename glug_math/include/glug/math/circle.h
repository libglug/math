...
GLUG_LIB_API int  glug_circle_equal(const struct glug_circle *a, const struct glug_circle *b);

GLUG_LIB_API int  glug_circle_contains_point(const struct glug_circle *cir, const struct glug_vec2 *p);
...
GLUG_LIB_API int glug_circle_intersects_circle(const struct glug_circle *a, const struct glug_circle *b);
