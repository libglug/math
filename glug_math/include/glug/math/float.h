...
GLUG_LIB_API bool glug_float_is_inf(float f);
GLUG_LIB_API bool glug_float_is_nan(float f);
GLUG_LIB_API bool glug_float_equal_strict(float f1, float f2);
GLUG_LIB_API bool glug_float_equal_approx(float f1, float f2, float diff);
GLUG_LIB_API bool glug_float_equal_ulps  (float f1, float f2, uint32_t ulps);

GLUG_LIB_API float glug_float_next(float f);
GLUG_LIB_API float glug_float_prev(float f);
GLUG_LIB_API enum float_error glug_float_load(float *res, float scalar, int exp);
GLUG_LIB_API void glug_float_unload(float f, float *scalar, int *exp);
GLUG_LIB_API float glug_float_rand(void);
GLUG_LIB_API void glug_float_swap(float *f1, float *f2);

GLUG_LIB_API bool glug_float_is_pow2(float f);
...
GLUG_LIB_API float glug_float_abs(float f);
...
GLUG_LIB_API float glug_float_round_inf(float f);
