...
GLUG_LIB_API int  glug_sphere_equal(const struct glug_sphere *a, const struct glug_sphere *b);

GLUG_LIB_API int  glug_sphere_contains_point(const struct glug_sphere *cir, const struct glug_vec3 *p);
...
GLUG_LIB_API int glug_sphere_intersects_sphere(const struct glug_sphere *a, const struct glug_sphere *b);
