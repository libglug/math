...
GLUG_LIB_API int  glug_line3_equal(const struct glug_line3 *a, const struct glug_line3 *b);
...
GLUG_LIB_API int glug_line3_contains_point(const struct glug_line3 *l, const struct glug_vec3 *p);
