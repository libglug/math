...
GLUG_LIB_API void glug_line3_from_points(struct glug_line3 *dst, const struct glug_vec3 *p1, const struct glug_vec3 *p2);

GLUG_LIB_API glug_bool_t glug_line3_equal(const struct glug_line3 *a, const struct glug_line3 *b);

GLUG_LIB_API void glug_line3_at_t(const struct glug_line3 *l, float t, struct glug_vec3 *dst);
