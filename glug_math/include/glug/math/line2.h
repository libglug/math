...
GLUG_LIB_API int  glug_line2_equal(const struct glug_line2 *a, const struct glug_line2 *b);
...
GLUG_LIB_API int glug_line2_contains_point(const struct glug_line2 *l, const struct glug_vec2 *p);
