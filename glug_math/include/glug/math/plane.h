...
GLUG_LIB_API int  glug_plane_equal(const struct glug_plane *a, const struct glug_plane *b);
...
GLUG_LIB_API int glug_plane_contains_point(const struct glug_plane *p, const struct glug_vec3 *r);
