...
GLUG_LIB_API int  glug_box_equal(const struct glug_box *a, const struct glug_box *b);

GLUG_LIB_API int glug_box_is_empty(const struct glug_box *b);

GLUG_LIB_API int  glug_box_contains_point(const struct glug_box *r, const struct glug_vec3 *p);
...
GLUG_LIB_API int glug_box_intersects_box(const struct glug_box *a, const struct glug_box *b);
