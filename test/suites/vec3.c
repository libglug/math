...
CU_pSuite create_vec3_suite()
{
    ...
    ADD_TEST(CU_add_test, vec3_suite, "equal", test_equal);
    ADD_TEST(CU_add_test, vec3_suite, "sum", test_sum);
    ADD_TEST(CU_add_test, vec3_suite, "difference", test_diff);
    ADD_TEST(CU_add_test, vec3_suite, "product", test_prod);
    ADD_TEST(CU_add_test, vec3_suite, "quotient", test_quot);
    ADD_TEST(CU_add_test, vec3_suite, "add", test_add);
    ADD_TEST(CU_add_test, vec3_suite, "subtract", test_sub);
    ADD_TEST(CU_add_test, vec3_suite, "multiply", test_mul);
    ADD_TEST(CU_add_test, vec3_suite, "divide", test_div);
    ADD_TEST(CU_add_test, vec3_suite, "dot", test_dot);
    ADD_TEST(CU_add_test, vec3_suite, "cross", test_cross);
    ADD_TEST(CU_add_test, vec3_suite, "length", test_len);
    ADD_TEST(CU_add_test, vec3_suite, "square length", test_len_sq);
    ADD_TEST(CU_add_test, vec3_suite, "manhattan length", test_len_mh);
    ADD_TEST(CU_add_test, vec3_suite, "set length", test_set_len);
    ADD_TEST(CU_add_test, vec3_suite, "is normal", test_is_norm);
    ADD_TEST(CU_add_test, vec3_suite, "normal", test_normal);
    ADD_TEST(CU_add_test, vec3_suite, "normalize", test_normalize);
    ADD_TEST(CU_add_test, vec3_suite, "distance", test_dist);
    ADD_TEST(CU_add_test, vec3_suite, "square distance", test_dist_sq);
    ADD_TEST(CU_add_test, vec3_suite, "manhattan distance", test_dist_mh);
    ADD_TEST(CU_add_test, vec3_suite, "angle between", test_angle_to);
    ADD_TEST(CU_add_test, vec3_suite, "projection", test_projection);
    ADD_TEST(CU_add_test, vec3_suite, "rejection", test_rejection);
    ADD_TEST(CU_add_test, vec3_suite, "reflection", test_reflection);
    ADD_TEST(CU_add_test, vec3_suite, "refraction", test_refraction);
    ADD_TEST(CU_add_test, vec3_suite, "project", test_project);
    ADD_TEST(CU_add_test, vec3_suite, "reject", test_reject);
    ADD_TEST(CU_add_test, vec3_suite, "reflect", test_reflect);
    ADD_TEST(CU_add_test, vec3_suite, "refract", test_refract);
